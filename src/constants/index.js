...
export const HERO_CONTENT = `I’m a full-stack developer who geeks out over turning ideas into clean, functional apps. Whether I’m poliishing a front-end with techologies like React and Tailwind or tinkering with a back-end using Node.js, Express and MongoDB, I thrive on building tools that work - not just for users, but for the teams scaling them. My goal? Code that's simple to maintain, interfaces that feel effortless, and solutions that quietly make everyone's day a little easier.`

export const ABOUT_TEXT = `I am a dedicated full stack developer with a passion for finding efficient solutions and making user-friendly web applications. While i mainly develop web applications with variety of technlogies like React, Tailwind, Node and MongoDB, I've become close with other languages like Java, Python and C# for everything from automating tasks to game mods. My coding journey began with a deep curiosity for how things work, and I am currently evolving into a career where I continuously strive to learn and adapt to new challenges. I thrive in collaborative environments and enjoy solving complex problems to deliver high-quality solutions. When I'm not at my desk, I'm probably shooting hoops, getting way too competitive at chess, or watching One Piece.`
